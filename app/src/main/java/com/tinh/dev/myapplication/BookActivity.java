...
import static com.tinh.dev.myapplication.Constant.COLUMN_MATHELOAI;
import static com.tinh.dev.myapplication.Constant.COLUMN_NXB;
import static com.tinh.dev.myapplication.Constant.COLUMN_SOLUONG;
import static com.tinh.dev.myapplication.Constant.COLUMN_TACGIA;
import static com.tinh.dev.myapplication.Constant.TB_COLUMN_NAME;
    ...
    public void deleteBook(final String masach, final int i) {
        ...
        builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(BookActivity.this, ""+i, Toast.LENGTH_SHORT).show();
                anhXa();
                addRecyclerview();
