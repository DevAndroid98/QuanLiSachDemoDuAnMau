...
public class LoginActivity extends AppCompatActivity{
    ...
    void KiemTra(){
        ...
        if (nguoiDung==null){
            ...
            StyleableToast.makeText(this,getString(R.string.notify_wrong_username_or_password),R.style.exampleToas).show();
        }else {
           ...
           if (password.equals(pass)){
               ...
               StyleableToast.makeText(this,getString(R.string.error),R.style.exampleToas).show();
           }
